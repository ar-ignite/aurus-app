# Generated by Django 4.2.19 on 2025-02-23 18:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['order'],
                'permissions': [('can_assign_menu', 'Can assign menu to groups')],
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_access_admin', 'Can access admin interface')],
            },
            managers=[
